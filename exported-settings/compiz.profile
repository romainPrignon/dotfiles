...
[core]
s0_active_plugins = core;composite;opengl;copytex;snap;commands;mousepoll;compiztoolbox;imgpng;workarounds;grid;vpswitch;place;regex;unitymtgrabhandles;move;wall;resize;expo;session;ezoom;staticswitcher;fade;scale;unityshell;
s0_outputs = 1280x1024+1280+0;1280x1024+0+0;
s0_autoraise = false
